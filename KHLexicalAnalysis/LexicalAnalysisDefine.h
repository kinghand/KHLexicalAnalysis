...
namespace KH{
	...
	const int _COMMA		= 0x0112;//	,
	const int _PERIOD		= 0x0113;//	.
	const int _EXCLAMATION	= 0x0114;//	!
	const int _QUESTION		= 0x0115;//	?
	const int _QUOTE		= 0x0116;//	"
	const int _SINGLEQUOTE	= 0x0117;//	'
	const int _COLON		= 0x0118;// :
	const int _SEMICOLON	= 0x0119;//	;
	const int _DOLLAR		= 0x011A;//	$
	const int _PERCENT		= 0x011B;//	%
	const int _POWER		= 0x011C;//	^
	const int _AT			= 0x011D;//	@
	const int _NON			= 0x011E;//	~
	const int _AND			= 0x011F;//	&
	const int _OR			= 0x0120;//	|
	const int _UNDERLINE	= 0x0121;//	_
	const int _ASSIGN		= 0x0122;//	:=
